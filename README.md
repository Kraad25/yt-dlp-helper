...
A simple desktop app to download videos or audio and edit their metadata using a clean Tkinter GUI.

## Download (Windows)

Download the portable Windows build (no installation needed):

- [yt-dlp-helper v1.2.0 for Windows](https://github.com/Kraad25/yt-dlp-helper/releases/tag/v1.2.0)
...
- Step‑by‑step metadata editor for downloaded files:
  ...
  - Rename files using:
    ...
    - `Title - Album`
    - `Title`
- **In-app updater** — keep yt-dlp and ffmpeg up to date without reinstalling the app (File → Update)
