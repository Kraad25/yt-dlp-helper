...
class MetadataController:
    def __init__(self):
        ...
        self._service = MetadataService(metadata_model=MetadataModel(), error_handler=self._error)
    ...
    def editing_requested(
        ...
        if not self._validate_folder(self._files):
            return
        show_wizard()
    ...
    def _validate_folder(self, files):
        if not files:
            self._error.handle_error(update_status=self._update_status,
